...
const Education = () => (
  <section id="education" className="py-20 px-6 bg-purple-50 dark:bg-gray-900">
    <h2 data-aos="fade-up" className="text-3xl font-bold text-center mb-8">Education</h2>
    <div data-aos="zoom-in" className="max-w-3xl mx-auto bg-white dark:bg-gray-800 shadow p-6 rounded-lg">
